  ...
  return (
    <div className={styles.aboutuswrapper}>
      ...
      <div className={styles.Aboutuscards}>
       <Aboutuscard img='/VR Array 1.png' title=' Cutting Edge Technology' description='Take the advantage of our cutting-edge solutions to increase your Return of Investment on IT.'/>
       <Aboutuscard img='/lines.png' title='Cross Device Compatibility' description='Multi-device compatibility ensures that creating, viewing and providing quick and easy' />
       <Aboutuscard img='/clock .png' title='Tailer Mode Development' description='Scalable and dynamic systems with the ever-changing trends to meet your dynamic business needs' />
       </div>
    </div>
  )
}
